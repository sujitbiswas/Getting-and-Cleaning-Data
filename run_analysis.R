...
#create tidy data
tidy = aggregate(relevantData, by=list(Activity = relevantData$Activity, Subject=relevantData$Subject), mean)
# Remove the subject and activity column as they are duplicate
tidy[,90] = NULL
tidy[,89] = NULL
